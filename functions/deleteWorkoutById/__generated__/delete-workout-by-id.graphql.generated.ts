...
export type DeleteWorkoutById__MutationVariables = Types.Exact<{
  id?: Types.InputMaybe<Types.Scalars['uuid']['input']>
}>

export type DeleteWorkoutById__Mutation = {
  __typename?: 'mutation_root'
  delete_workouts?: {
    __typename?: 'workouts_mutation_response'
    returning: Array<{
...
export const DeleteWorkoutById__Document = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'DeleteWorkoutById__' },
      variableDefinitions: [
        {
  ...
  DeleteWorkoutById__Mutation,
  DeleteWorkoutById__MutationVariables
>
